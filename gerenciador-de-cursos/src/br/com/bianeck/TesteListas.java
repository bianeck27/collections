...
public class TesteListas {
	...
	public static void main(String[] args) {
		...
		System.out.println("Remoção na ArrayList demorou " + tempoArrayList);
		System.out.println("Remoção na LinkedList demorou " + tempoLinkedList);
	}
	...
	private static long removePrimeirosElementos(List<Integer> numeros) {
		...
		for (int i = 0; i < 100; i++) {
			numeros.remove(0);// remove sempre o primeiro elemento
		}
